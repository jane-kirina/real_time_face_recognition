...
**The goal:**
- working pipeline + good explanation
- Ability to explain:
	- why embeddings?
	- how threshold works?
	- how you reduce false positives?
	- why FAISS?
	- how you handle unknown faces?
	- why this architecture/solution?
	- how to expand?
...
The rules:
- Stick to the plan
- Create finished thing
- learn it now -> implement it now
- If something takes >2–3 hours:
	- simplify
	- move forward
	- come back later
- If no time, cut:
...
3 week, if it possible:
- SQL part
- face clustering for unknown people
- benchmark report: FPS, latency, precision at different thresholds
- ? liveness / spoof warning as separate module
- ? edge deployment on weaker hardware
