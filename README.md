...
- Clear README + demo
- Understanding embeddings, trade-offs and
...
| 3   | ✔      | *Completed tasks from 3-6 days*<br>Add detect + embedding<br>Research: embedding, FaceNet vs ArcFace<br>saving embeddings to file<br>comparing new embeddings to saved ones<br>threshold for known / unknown face<br>Some optimizations<br>Added `handle_keypress` to webcam `start_camera()`<br>- exit<br>- save frame to folder `/outputs`<br>- pause frame + overlay text 'Paused' | 4h   |
| 4   | ➖      |                                                                                                                                                                                                                                                                                                                                                                                       |      |
| 5   | ➖      |                                                                                                                                                                                                                                                                                                                                                                                       |      |
| 6   | ➖      |                                                                                                                                                                                                                                                                                                                                                                                       |      |
| 7   | ➖      |                                                                                                                                                                                                                                                                                                                                                                                       |      |
